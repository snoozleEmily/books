...
-- Insert data into the Chakra Relations table
...
DECLARE
  player_element_id NUMBER := 1; -- Assign your desired player element ID here
  enemy_element_id NUMBER := 2;  -- Assign your desired enemy element ID here
